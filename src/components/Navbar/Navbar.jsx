...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    { id: "workProjects", label: "Projects" },
    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">Gatkul</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/somnathdeveloper"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/somnath-gatkul?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BslmgC71ARV2zQJNs9X%2ByHg%3D%3D"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
